...
def compare_plot(xlabel, ylabel, x, yrange, ours, impala, tsp, ran):
    ...
    plt.plot(x, tsp, color='k', marker='d', label='GA-based route planning', markersize=30, markeredgewidth=5,
             ...
             linewidth=4)
    plt.plot(x, ran, color='orange', marker='s', label='Policy of exploration', markersize=30, markeredgewidth=5,
             markerfacecolor='none',
             linewidth=4)
